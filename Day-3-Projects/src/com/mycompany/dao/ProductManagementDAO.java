...
public class ProductManagementDAO {
    ...
    public List<Product> getAllProducts()
    {
        ...
        try
        {
            ...
            while(rs.next())
            {
                Product product = new Product(rs.getString("id"), rs.getString("username"), rs.getInt("price"));
    ...
    public Product getProductByid(String productId)
    {
        ...
        try
        {
            ...
            while(rs.next())
            {
                product = new Product(rs.getString("id"), rs.getString("username"), rs.getInt("price"));
            }
        }
        catch(Exception e)
        {
    ...
    public int updateProduct(Product product)
    {
        ...
        {
            Connection conn = DBUtil.getConnection();
            PreparedStatement ps = conn.prepareStatement("UPDATE product SET username=?, price=? WHERE id=?");
            //set parameters of query here but using the values for the product object
